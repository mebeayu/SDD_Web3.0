...
namespace RRL.WEB
{
    public class SwaggerConfig
    {
                ...
                .EnableSwagger(c =>
                    {
                        ...
                        //
                        c.SingleApiVersion("v1", PlatFormConfig.DocName);
                        ...
                        //    (vc) =>
                        //    {
                        //        vc.Version("v1", "v1接口测试工具");
                        //        vc.Version("v2", "v2接口测试工具");
                        //    });
                ...
                .EnableSwaggerUi("Document/{*assetPath}", c =>
                     {
                         ...
                         //
                         c.DocumentTitle(PlatFormConfig.DocName);

                         // Use the "InjectStylesheet" option to enrich the UI with one or more additional CSS stylesheets.
                         // The file must be included in your project as an "Embedded Resource", and then the resource's
                         // "Logical Name" is passed to the method as shown below.
                         //
                         //c.InjectStylesheet(thisAssembly, "RRL.WEB.App_Data.Swagger.css");

                         // Use the "InjectJavaScript" option to invoke one or more custom JavaScripts after the swagger-ui
                         // has loaded. The file must be included in your project as an "Embedded Resource", and then the resource's
                         // "Logical Name" is passed to the method as shown above.
                         //
                         c.InjectJavaScript(thisAssembly, "RRL.WEB.App_Data.Swagger.js");
        ...
        private static string GetXmlCommentsPath()
        {
            ...
            string commentsFileName = @"App_Data\RRL.WEB.XML";
