...
namespace RedisHelp
{
    ...
    public class RedisHelper
    {
        ...
        {
            DbNum = dbNum;
            _conn = string.IsNullOrWhiteSpace(connectionString) ?
        ...
        public bool HashSetStr(string key, string dataKey, string t)
        {
            ...
            {
                //string json = ConvertJson(t);
                return db.HashSet(key, dataKey, t);
            });
        }
         ...
         * @return 是否获取成功
         */
        public   bool LockTake(  String lockKey ,string lockValue )
        {
            var db=_conn.GetDatabase();
            var isTake=db.LockTake(lockKey, lockValue, TimeSpan.FromSeconds(60));
            return isTake;
        }
