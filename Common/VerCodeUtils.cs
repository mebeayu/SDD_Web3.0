...
namespace Common
{
    ...
    public class YZMHelper
    {
        ...
        private Font[] fonts =
      {
    new Font(new FontFamily("Times New Roman"),24 +Next(1),System.Drawing.FontStyle.Regular),
    new Font(new FontFamily("Georgia"), 24 + Next(1),System.Drawing.FontStyle.Regular),
    new Font(new FontFamily("Arial"), 24 + Next(1),System.Drawing.FontStyle.Regular),
    new Font(new FontFamily("Comic Sans MS"), 24 + Next(1),System.Drawing.FontStyle.Regular)
  };
        #endregion
        #region 公有属性
        /// <summary>
        ...
        public void CreateImage()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                g.DrawLine(new Pen(Color.Silver,3), x1, y1, x2, y2);
            }
            int _x = -8, _y = 0;
