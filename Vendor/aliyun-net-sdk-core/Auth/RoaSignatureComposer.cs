...
namespace Aliyun.Acs.Core.Auth
{
    public class RoaSignatureComposer : ISignatureComposer
    {
        ...
        {
            var queIndex = uri.IndexOf("?", StringComparison.Ordinal);
        ...
        public string ComposeStringToSign(MethodType? method, string uriPattern, Signer signer, Dictionary<string, string> queries, Dictionary<string, string> headers, Dictionary<string, string> paths)
        {
            var sb = new StringBuilder();
            sb.Append(method).Append(HeaderSeparator);
        ...
        {
            return composer ?? (composer = new RoaSignatureComposer());
        }
    }
}
