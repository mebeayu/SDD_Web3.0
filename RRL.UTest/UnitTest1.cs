...
namespace RRL.UTest
{
    ...
    public class UnitTest1
    {
        ...
        {
            RedisHelper redis = new RedisHelper(0, "127.0.0.1:6379");// 127.0.0.1:6380 127.0.0.1:6381 127.0.0.1:6382 127.0.0.1:6383 127.0.0.1:6384");
            ...
            tran.StringSetAsync("{app_id}/tran_string", "test1");
            tran.StringSetAsync("{app_id}/tran_string1", "test2");
